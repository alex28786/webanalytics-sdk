...
export function md5(s) {
    ...
    var C = Array(); var P, h, E, v, g, Y, X, W, V; var S = 7, Q = 12, N = 17, M = 22; var A = 5, z = 9, y = 14, w = 20; var o = 4, m = 11, l = 16, j = 23; var U = 6, T = 10, R = 15, O = 21; s = J(s); C = e(s); Y = 1732584193; X = 4023233417; W = 2562383102; V = 271733878;
...
/**
 * Strips delimiters from product strings
 */
export function stripProductDelimiters(val) {
    if (val) {
...
export function setCookie(name, value, seconds, domain) {
    // domain = document.location.hostname; // Default to current hostname if not passed? 
    // Logic from legacy:
    // domain = document.location.hostname; -> overwrites arg? no, argument is last arg.
    // The legacy code reassigns domain inside:
    var d = domain || (typeof document !== 'undefined' ? document.location.hostname : '');
...
export function deleteCookie(name) {
    var domain = (typeof document !== 'undefined' ? document.location.hostname : '');
    setCookie(name, '', -1);
...
export function parseListToKeyValuePairs(value, delimiter) {
