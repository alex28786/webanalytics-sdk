(function () {
    ...
    const ORG_ID = "4D6368F454EC41940A4C98A6@AdobeOrg";
    /**
     * MD5 implementation
     * @param {string} s 
     ...
     */
    function stripProductDelimiters(val) {
        if (val) {
    ...
    function parseListToKeyValuePairs$1(value, delimiter) {
    ...
    const dataElements = {
        ...
        "Page - Context Domain": function () {
            for (var e = ["contextDomain", "host", "version", "platform"], t = [], n = false, a = 0; a < e.length; a++) {
                var r = e[a];
        ...
        "Page - Journal Publisher": function () {
            for (var e = ["businessPublisherName", "businessPublisherId", "productionPublisherName", "productionPublisherId"], t = [], n = true, a = 0; a < e.length; a++) {
                var r = e[a];
     ...
     */
    function resolveDataElement(name) {
    ...
    function validateData(data, warnings) {
        if (!data) {
            warnings.push('dv0');
            return;
        }
    ...
    const pageDataTracker = {
        ...
        parseListToKeyValuePairs: parseListToKeyValuePairs$1,
    ...
    function mapIntoXdm(s, xdm, context) {
    ...
    function attachPlugins(s) {
        if (!s) return;

        s.Util = {};
        s.Util.getQueryParam = function getQueryParam(a, d, f) { function n(g, c) { c = c.split("?").join("&"); c = c.split("#").join("&"); var e = c.indexOf("&"); if (g && (-1 < e || c.indexOf("=") > e)) { e = c.substring(e + 1); e = e.split("&"); for (var h = 0, p = e.length; h < p; h++) { var l = e[h].split("="), q = l[1]; if (l[0].toLowerCase() === g.toLowerCase()) return decodeURIComponent(q || true) } } return "" } if ("-v" === a) return { plugin: "getQueryParam", version: "4.0.1" }; var b = function () { if ("undefined" !== typeof window.s_c_il) for (var g = 0, c; g < window.s_c_il.length; g++)if (c = window.s_c_il[g], c._c && "s_c" === c._c) return c }(); "undefined" !== typeof b && (b.contextData.getQueryParam = "4.0"); if (a) { d = d || ""; f = (f || "undefined" !== typeof b && b.pageURL || location.href) + ""; (4 < d.length || -1 < d.indexOf("=")) && f && 4 > f.length && (b = d, d = f, f = b); b = ""; for (var m = a.split(","), r = m.length, k = 0; k < r; k++)a = n(m[k], f), "string" === typeof a ? (a = -1 < a.indexOf("#") ? a.substring(0, a.indexOf("#")) : a, b += b ? d + a : a) : b = "" === b ? a : b + (d + a); return b } };
        ...
        if (!s.__ccucr) {
            ...
            s.__ccucr = true;
            function c_r(k) {
                var s = this, v = s.c_rr(k), c = s.c_rspers(), i, m, e;
        ...
        if (!s.__ccucw) {
            ...
            function c_w(k, v, e) {
                ...
                var s = this, d = new Date, ht = 0, pn = 's_pers', sn = 's_sess', pc = 0, sc = 0, pv, sv, i, t, f;
